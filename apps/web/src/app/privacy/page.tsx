...
export default function PrivacyPage() {
  return (
    <article className="flex max-w-2xl flex-col gap-4 text-sm leading-relaxed text-zinc-700">
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">No accounts</h2>
      <p>
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">Analytics</h2>
      <p>
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">Advertising &amp; affiliate links</h2>
      <p>
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">Server logs</h2>
      <p>
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">Changes to this policy</h2>
      <p>
