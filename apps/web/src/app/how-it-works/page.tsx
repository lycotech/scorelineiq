...
export default function HowItWorksPage() {
  return (
    <article className="flex max-w-2xl flex-col gap-4 text-sm leading-relaxed text-zinc-700">
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">1. Expected goals</h2>
      <p>
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">2. A Poisson goal model</h2>
      <p>
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">3. An Elo strength adjustment</h2>
      <p>
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">4. Published transparently</h2>
      <p>
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">What this isn&apos;t</h2>
      <p>
      ...
      <h2 className="mt-2 text-lg font-semibold text-zinc-950">Current limitations</h2>
      <p>
